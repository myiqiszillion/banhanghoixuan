...
const SEGMENTS = [
    { emoji: '🧧', name: 'Chúc may mắn', color: '#FFF7ED', textCol: '#C2410C', isLose: true }, // Cream
    ...
    { emoji: '💰', name: '10K Tiền mặt', color: '#F59E0B', textCol: '#78350F', isLose: false }, // Gold
    { emoji: '🧧', name: 'Chúc may mắn', color: '#FFF7ED', textCol: '#C2410C', isLose: true },
    { emoji: '🥤', name: '01 Ly nước', color: '#2563EB', textCol: '#FFFFFF', isLose: false },  // Blue
    { emoji: '🧧', name: 'Chúc may mắn', color: '#FFF7ED', textCol: '#C2410C', isLose: true },
    { emoji: '🍡', name: '01 Xiên', color: '#DC2626', textCol: '#FEF3C7', isLose: false }, // Red
];
